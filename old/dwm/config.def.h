...
// static const char *shutdowncmd[] = {"sudo", "sh", "-c", "\"sync", "&&", "/bin/systemctl", "poweroff\"", NULL};
static const char *shutdowncmd[] = {"sudo", "sh", "-c", "sync && /bin/systemctl poweroff", NULL};
static const char *rebootcmd[] = {"sudo", "sh", "-c", "sync && /bin/systemctl reboot", NULL};
...
//static const char *piToHdmi[] = {"ssh", "pi@pi", "-i", "/home/lean/.ssh/pikey", "\"./cec.sh", "31\"", NULL };
static const char *pitohdmi[] = {"/home/lean/.dotfiles/scripts/cec.sh", "1", NULL };
static const char *hdmitopi[] = {"/home/lean/.dotfiles/scripts/cec.sh", "2", NULL };
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F3,     spawn,          {.v = pitohdmi } }, // PI TO HDMI-1
        { MODKEY|ShiftMask,                       XK_F3,     spawn,          {.v = hdmitopi } }, // PI TO HDMI-2
